            ...
            <div class="row mob-masonry">
                ...
                <if value="$lang['tips']">
                    <div class="col-lg-2 col-md-3 col-xs-12 list masonry-item foot-nav">
                        <h4 class='font-size-16 m-t-0'>{$lang.tips}</h4>
                        <div class="code-img full-img">
                            <img src="{$lang.tipsimg|thumb:87,87}" title="{$lang.tips}"/>
                        </div>
                    </div>
                </if>
                <!-- 公众号end -->
                <div class="col-lg-3 col-md-12 col-xs-12 info media-info masonry-item font-size-20" m-id='met_contact' m-type="nocontent">
                    ...
                    <h4 class='font-size-16 m-t-0 '>{$lang.footinfo_tel}</h4>
                    </if>                
                    <if value="$lang['footinfo_dsc']">
                    <p class="foot-tel"><a href="tel:{$lang.footinfo_dsc}" title="{$lang.footinfo_dsc}">{$lang.footinfo_dsc}</a></p>
                    </if>
                    <if value="$lang['footinfo_time']">
                    <p class="foot-time font-size-14">{$lang.footinfo_time}</p>
                    </if>
        ...
        <!--友情链接-->
            ...
            <div class="copy p-y-10 border-top1 foot-right">
                <div class="text-xs-center">
                    ...
                    <div class="footaddress">{$c.met_footaddress}</div>
                    </if>
                    <if value="$c['met_foottel']">
                    <div class="foottel">{$c.met_foottel}</div>
                    </if>
                    <if value="$c['met_footother']">
                    <div class='footother'>{$c.met_footother}</div>
                    </if>
                    <if value="$c['met_foottext']">
                    <div class="foottext">{$c.met_foottext}</div>
                    </if>
