...
<div class="met-img animsition lh-other-box">
    <div class="container">
        <div class="row">
            ...
            <tag action='category' cid="$data['classnow']" type="son" num="$c['met_img_list']"></tag>
            <else/>
            ...
            blocks-md-2 blocks-lg-4 blocks-xxl-4" data-scale='{$c.met_imgs_y}x{$c.met_imgs_x}' m-id='noset'>
