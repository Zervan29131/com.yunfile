        ...
        <div class="row">
            ...
            <div class="row">
                <div class="met-bar" m-id="news_bar" m-type="nocontent">
                    ...
                    <if value="$lang['product_bar_list_open']">
                        <div class="sidebar-news-list recommend">
                            <h3 class=' font-weight-300 m-t-10'>{$lang.product_bar_list_title}</h3>
                             <ul class="list-group list-group-bordered m-t-10 m-b-0 product-list-group">
                                <tag action='list'  cid="$lang['product_bar_id']" num="$lang['product_bar_list_num']" type="$lang['product_bar_list_type']" mode="3s">
                                <li class="list-group-item">
                                    <a href="{$v.url}" title="{$v.title}" {$g.urlnew}>
                                    <img class="cover-image lazy" data-original="{$v.imgurl}" alt="{$v.title}" >
                                    <p class="m-t-10 m-b-10 text-xs-center">{$v.title}</p>
                                </a>
                                </li>
                                </tag>
                            </ul>
